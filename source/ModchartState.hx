...
class ModchartState
{
	...
	function makeAnimatedLuaSprite(spritePath:String,names:Array<String>,prefixes:Array<String>,startAnim:String, id:String)
	{
		...
		// Lua modcharts are soy to begin with, but they should at least FUCKING WORK AND NOT BE BROKEN BY A CONTIBUTOR LMAO.
    ...
    function new()
    {
        		trace('opening a lua state (because we are fucking soyjak programmers :O))'); // corrected this. It used to say "cool :)"
				lua = LuaL.newstate();
				LuaL.openlibs(lua);
				...
				// pre lowercasing the song name (ModChartState.new())
				var songLowercase = StringTools.replace(PlayState.SONG.song, " ", "-").toLowerCase();
				switch (songLowercase) {
					case 'dad-battle': songLowercase = 'dadbattle';
					case 'philly-nice': songLowercase = 'philly';
