...
class DialogueBox extends FlxSpriteGroup
{
	...
	if (PlayState.SONG.song.toLowerCase()=='hornz')
	{
		portraitLeft = new FlxSprite(-100, 167);
	...
	if (PlayState.SONG.song.toLowerCase()=='daemon')
	{
		portraitLeft = new FlxSprite(-100, 167);
		portraitLeft.frames = Paths.getSparrowAtlas('weeb/port');
		portraitLeft.animation.addByPrefix('enter', 'portrait', 24, false);
	...
	if (PlayState.SONG.song.toLowerCase()=='floss')
	{
		portraitLeft = new FlxSprite(-100, 167);
	...
	if (PlayState.SONG.song.toLowerCase()=='trolling')
	{
		portraitLeft = new FlxSprite(-100, 167);
		portraitLeft.frames = Paths.getSparrowAtlas('weeb/port');
		portraitLeft.animation.addByPrefix('enter', 'portrait', 24, false);
		...
		if (FlxG.keys.justPressed.ANY  && dialogueStarted == true)
		{
			...
			if (dialogueList[1] == null && dialogueList[0] != null)
			{
				if (!isEnding)
				{
					...
					if (PlayState.SONG.song.toLowerCase() == 'senpai' || PlayState.SONG.song.toLowerCase() == 'thorns' || PlayState.SONG.song.toLowerCase() == 'hornz' || PlayState.SONG.song.toLowerCase() == 'daemon' || PlayState.SONG.song.toLowerCase() == 'trolling' || PlayState.SONG.song.toLowerCase() == 'floss')
